...
I will be adding folders to this repository so please do check back regularly to see what is new. My next upload will be a full stack implementation with a frontend React application that allows for full CRUD operations on a database of "car" objects which are served via an Express backend with a connection via Mongoose to a MongoDB collection.
